...
<body>
	<div class="text-center">
		<h5>
			<a href="#" class="top_message">지금 가입시 1000포인트 적립</a>
		</h5>
	</div>
	<nav class="navbar navbar-expand-lg navbar-white bg-white static-top">
		<div class="container">
			<a class="navbar-brand" href="#"> <img src="${root}img/logo.jpg">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link" href="${root}member/regist.do">회원가입</a></li>
					<li class="nav-item"><a class="nav-link" href="${root}member/login.do">로그인</a></li>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav">
							<li class="dropdown mr-5"><a
								class="dropdown-toggle menulist" href="#" id="navbarDropdown"
