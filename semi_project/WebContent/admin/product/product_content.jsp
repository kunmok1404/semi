...
$(function(){
	...
	<section>
        <div class="container">
            <h5>상품 기본 정보</h5><hr>
            <form action="product_content.do" method="post" enctype="multipart/form-data">       
            <table class="table table-bordered">
                <tbody>
                        ...
                        <td colspan="3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="category" name="category" required>
                                    ...
                                    <option ${cdto.product_category_name eq vdto.product_category_name?"selected":""}>${cdto.product_category_name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="form-control" name="name" value="${vdto.p_name}" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="table-light text-center prd_regist">상품번호</td>
                        <td colspan="3"><input type="hidden" name="p_id" value="${vdto.p_id}">${vdto.p_id}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="form-control" name="size" value="${vdto.p_size}" required></td>
                    </tr>
                    <tr>
                        <td class="table-light text-center prd_regist">단위</td>
                        <td colspan="3"><input type="text" class="form-control" name="unit" value="${vdto.unit}" required></td>
                    </tr>
<!--                     <tr> -->
...
<!--                     </tr> -->
                    <tr>
                        ...
                        <td><input type="number" class="form-control" name="apply_price" value="${vdto.apply_price}" required></td>
                        <td class="table-light text-center prd_regist">기준판매가격</td>
                        <td><input type="number" class="form-control" name="origin_price" value="${vdto.origin_price}" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control" name="stock" value="${vdto.stock}" required></td>
                    </tr>
                    <tr>
                        <td class="table-light text-center prd_regist">총판매량</td>
                        <td></td>
                        <td class="table-light text-center prd_regist">등록일</td>
                        <td>${vdto.regist_date}</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <label for="delv"></label>
                                <select class="form-control" id="delv" name="new_yn">
                                	<option ${vdto.new_yn eq "예"?"selected":""}>예</option>
                                    <option ${vdto.new_yn eq "아니오"?"selected":""}>아니오</option>
                                </select>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group">
                                <label for="delv"></label>
                                <select class="form-control" id="delv" name="sale_yn">
                                	<option ${vdto.sale_yn eq "예"?"selected":""}>예</option>
                                    <option ${vdto.sale_yn eq "아니오"?"selected":""}>아니오</option>
                                </select>
                            </div>
                        </td>
                    </tr>  
                    <tr>
                        <td class="table-light text-center prd_regist">승인상태</td>
                        <td>
                        	${vdto.apply_status}
                        </td>
                        <td class="table-light text-center prd_regist">판매상태</td>
                        <td>
                            <div class="form-group">
                                <label for="sale"></label>
                                <select class="form-control" id="sale" name="sale_status">
                                	<option ${vdto.sale_status eq "판매중"?"selected":""}>판매중</option>
                                    <option ${vdto.sale_status eq "판매중지"?"selected":""}>판매중지</option>
                                </select>
                            </div>
                        </td>
                    </tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="select">
                                            ...
                                            <option ${vdto.m_name eq item.name?"selected":""}>${item.name}</option>
                                      		</c:forEach>
                                        </select>
                                    </div>
                                </td>
