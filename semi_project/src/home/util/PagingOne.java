...
import home.beans.OneDao;
import home.beans.OneDto;
...
public class PagingOne {
	...
	//생성자
	public PagingOne(HttpServletRequest request) {
	...
	private List<OneDto> list;//데이터가 저장된 목록
	...
	public void calculate() throws Exception{
		...
		list = bdao.list(user,grade, start, end);	
