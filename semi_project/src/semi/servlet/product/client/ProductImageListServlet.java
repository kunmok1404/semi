...
@WebServlet(urlPatterns = "/product/product_image.do")
public class ProductImageListServlet extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, 
		...
		try {
			...
			ProductImgDto vdto = idao.getProductList(product_id);
			resp.reset();
